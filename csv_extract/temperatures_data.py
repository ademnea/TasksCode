...
def get_data():
    ...
    query = ("SELECT record, created_at FROM hive_temperatures "
...
def save_data(data):
    ...
    with open('/var/www/html/ademnea_website/MODULES/csv_data/hive_temperatures_hive1.csv', 'w', newline='') as csvfile:
