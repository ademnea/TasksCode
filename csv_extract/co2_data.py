...
def get_data():
    ...
    query = ("SELECT record, created_at FROM hive_carbondioxide "
...
def save_data(data):
    ...
    with open(':/var/www/html/ademnea_website/MODULES/csv_data/hive_carbondioxide_hive1.csv', 'w', newline='') as csvfile:
